...
#' @description
#' Funkcja przygotowuje obiekt do modyfikacji skali, który nie zawiera zbędnych kryteriów i pseudokryteriów.
#' @param skalowanie lista zawierająca obiekt usunieteKryteria - wektor nazw kryteriów do usunięcia.
...
#' @return Funkcja zwraca ramkę danych, która podana do funkcji \code{\link[ZPD]{edytuj_skale}} usunie z niej zbędne (pseudo)kryteria.
#' @import RODBCext
#' @export
usun_kryteria_ze_skali_es <- function(skalowanie, idSkali,  zrodloDanychODBC = "EWD"){
