...
#' wykorzystujących wyniki wyskalowane i zapisuje go w aktywnym katalogu.
#' @details Funkcja działa w oparciu o dane dostępne lokalnie, ściągnięte
#' wcześniej przy pomocy funkcji \code{\link{pobierz_wyniki_wyskalowane}}.
#' @param katalogZDanymi ciąg znaków - ścieżka do katalogu, w którym znajdują
#' się pliki .RData z wyskalowanymi wynikami egzaminów i danymi kontekstowymi
...
#' @export
przygotuj_dane_wyskalowane_do_ewd = function(katalogZDanymi, typSzkoly,
